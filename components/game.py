...
from dino_runner.components.player_hearts.player_heart_manager import PlayerHearManager
...
class Game:
    def __init__(self):
        ...
        self.death_count = 0
        self.running = True
        self.player_heart_manager = PlayerHearManager()
